...
import amazonLogo from '../assets/images/partners/zebra-logo.png';
import discordLogo from '../assets/images/partners/nazarbaev-uni.png';
import netflixLogo from '../assets/images/partners/astana-it.png';
import redditLogo from '../assets/images/partners/drinkit-logo.png';
import spotifyLogo from '../assets/images/partners/mega-logo.png';
...
class Mainpage extends Component {
  state = {
    provide: [
      "Timur: as the project manager, I ensure our coffeeshop vision stays on track, coordinating efforts to deliver a unique and customer-focused experience.",
      "Shyngys: as a front-end developer, I design an intuitive and visually appealing interface for our coffeeshop platform, making it easy for customers to explore and order.",
      "Nurtileu: as a back-end developer, I build the robust systems and logic that power our coffeeshop, ensuring smooth operations and reliable service for every customer.",
    ],
    reviews: [
      {
        name: "Alikhan",
        ...
        <main>
          <section className="bg-main bg-cover bg-center py-20 text-white font-bold">
            <div className="global-px">
              <div className="flex flex-col gap-6 w-[75%] lg:w-[50%] text-sm">
                <h2 className="text-4xl text-[#FFEEE7] font-bold">
                  We are ready to introduce you our startup
                </h2>
                <p> 
                CoffeeUp makes it easy to order your favorite coffee and meals in just a few taps. 
                Whether youre on the go or taking a break, we bring the best flavors straight to you!
                </p>
                <div className="mt-5">
                  <Link
                    className="bg-secondary px-6 py-4 text-[#FFEEE7] rounded-xl"
                    to={"/products/"}
                  >
                    Get Started
                  </Link>
          ...
          <section className="flex flex-col lg:flex-row global-px py-20 lg:gap-32">
            ...
            <div className="flex-1 flex flex-col justify-center gap-5">
              ...
              Our coffeeshop project is driven by a dedicated team of a project manager, front-end and back-end developers, 
              all working together to craft a seamless and delightful coffee experience for our customers.
              </p>
                  ...
                  >
                    <div className="flex flex-row gap-2 items-center">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-primary text-sm">Astana, Kazakhstan</p>
                      </div>
